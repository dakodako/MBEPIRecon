filename = 'meas_MID00181_FID27427_ep2d_bold_p2_sms4_1p8iso_20slc_10meas_matchAjuVol_offiso-015.dat';
twix_obj = mapVBVD(filename);
%%
NSlc = twix_obj.image.sqzSize(4);
MB = twix_obj.hdr.Meas.MultiBandFactor;
NSlc_mb = NSlc/MB;
...
%%
for m = 1:NMeas
    filename = strcat('siemens_raw/image_meas_',num2str(m)); % load img raw data
    load(filename);
